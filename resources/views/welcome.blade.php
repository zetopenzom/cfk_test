    ...
    <body class="font-sans antialiased min-h-screen grid place-items-center">
        @if (Route::has('login'))
            <div class="absolute top-0 right-0 p-6">
                @auth
                    <a href="{{ route('notes.index') }}" class="text-indigo-600 hover:text-indigo-800">Beranda</a>
                @else
        ...
        @endif
        {{-- <h1 class="text-7xl">Kaltim Electrik Power</h1> --}}
        <img src="assets/brand/kep-high-tr.png" style="max-width: 1000px;">
    </body>
</html>
